...
class ProductTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'muebleria.map.ProductTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addColumn('product_long', 'ProductLong', 'VARCHAR', false, 255, null);
        $this->addColumn('product_high', 'ProductHigh', 'VARCHAR', false, 255, null);
        $this->addColumn('product_depth', 'ProductDepth', 'VARCHAR', false, 255, null);
        // validators
    } // initialize()
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Material', 'Material', RelationMap::ONE_TO_MANY, array('idproduct' => 'idproduct', ), 'CASCADE', 'CASCADE', 'Materials');
        ...
        $this->addRelation('Productquestion', 'Productquestion', RelationMap::ONE_TO_MANY, array('idproduct' => 'idproduct', ), 'CASCADE', 'CASCADE', 'Productquestions');
    } // buildRelations()
