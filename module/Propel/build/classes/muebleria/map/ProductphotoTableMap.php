...
class ProductphotoTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'muebleria.map.ProductphotoTableMap';
    ...
    public function initialize()
    {
        ...
        $this->addColumn('productphoto_name', 'ProductphotoName', 'VARCHAR', true, 255, null);
        $this->addColumn('productphoto_url', 'ProductphotoUrl', 'VARCHAR', true, 255, null);
        // validators
    } // initialize()
