...
abstract class BaseCategoryPeer
{
    ...
    /** the column name for the category_dependency field */
    const CATEGORY_DEPENDENCY = 'category.category_dependency';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idcategory', 'CategoryName', 'CategoryDependency', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idcategory', 'categoryName', 'categoryDependency', ),
        BasePeer::TYPE_COLNAME => array (CategoryPeer::IDCATEGORY, CategoryPeer::CATEGORY_NAME, CategoryPeer::CATEGORY_DEPENDENCY, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDCATEGORY', 'CATEGORY_NAME', 'CATEGORY_DEPENDENCY', ),
        BasePeer::TYPE_FIELDNAME => array ('idcategory', 'category_name', 'category_dependency', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idcategory' => 0, 'CategoryName' => 1, 'CategoryDependency' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idcategory' => 0, 'categoryName' => 1, 'categoryDependency' => 2, ),
        BasePeer::TYPE_COLNAME => array (CategoryPeer::IDCATEGORY => 0, CategoryPeer::CATEGORY_NAME => 1, CategoryPeer::CATEGORY_DEPENDENCY => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDCATEGORY' => 0, 'CATEGORY_NAME' => 1, 'CATEGORY_DEPENDENCY' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('idcategory' => 0, 'category_name' => 1, 'category_dependency' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CategoryPeer::CATEGORY_DEPENDENCY);
        } else {
            $criteria->addSelectColumn($alias . '.idcategory');
            $criteria->addSelectColumn($alias . '.category_name');
            $criteria->addSelectColumn($alias . '.category_dependency');
        }
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(CategoryPeer::IDCATEGORY) && $criteria->keyContainsValue(CategoryPeer::IDCATEGORY) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(CategoryPeer::IDCATEGORY);
            $value = $criteria->remove(CategoryPeer::IDCATEGORY);
            if ($value) {
                $selectCriteria->add(CategoryPeer::IDCATEGORY, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(CategoryPeer::IDCATEGORY, (array) $values, Criteria::IN);
        }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(CategoryPeer::CATEGORY_DEPENDENCY, $obj->getIdcategory());
            $affectedRows += CategoryPeer::doDelete($criteria, $con);

            // delete related Product objects
            $criteria = new Criteria(ProductPeer::DATABASE_NAME);

            $criteria->add(ProductPeer::IDCATEGORY, $obj->getIdcategory());
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(CategoryPeer::DATABASE_NAME);
        $criteria->add(CategoryPeer::IDCATEGORY, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(CategoryPeer::DATABASE_NAME);
            $criteria->add(CategoryPeer::IDCATEGORY, $pks, Criteria::IN);
