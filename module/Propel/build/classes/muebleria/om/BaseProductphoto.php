...
abstract class BaseProductphoto extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the productphoto_name field.
     * @var        string
     */
    protected $productphoto_name;
    ...
    /**
     * Get the [productphoto_name] column value.
     *
     * @return string
     */
    ...
    /**
     * Set the value of [productphoto_name] column.
     *
     * @param  string $v new value
     * @return Productphoto The current object (for fluent API support)
     */
    public function setProductphotoName($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->productphoto_name !== $v) {
            $this->productphoto_name = $v;
            $this->modifiedColumns[] = ProductphotoPeer::PRODUCTPHOTO_NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->productphoto_name = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->productphoto_url = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->resetModified();
            ...
            return $startcol + 4; // 4 = ProductphotoPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProductphotoPeer::PRODUCTPHOTO_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`productphoto_name`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`idproduct`':
                        ...
                        break;
                    case '`productphoto_name`':
                        $stmt->bindValue($identifier, $this->productphoto_name, PDO::PARAM_STR);
                        break;
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                return $this->getProductphotoName();
                break;
            case 3:
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getProductphotoName(),
            $keys[3] => $this->getProductphotoUrl(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                $this->setProductphotoName($value);
                break;
            case 3:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setProductphotoName($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setProductphotoUrl($arr[$keys[3]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductphotoPeer::PRODUCTPHOTO_NAME)) $criteria->add(ProductphotoPeer::PRODUCTPHOTO_NAME, $this->productphoto_name);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setProductphotoName($this->getProductphotoName());
