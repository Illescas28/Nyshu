...
abstract class BaseProduct extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the product_depth field.
     * @var        string
     */
    ...
    /**
     * @var        PropelObjectCollection|Productphoto[] Collection to store aggregation of Productphoto objects.
     */
    protected $collProductphotos;
    protected $collProductphotosPartial;

    /**
     * @var        PropelObjectCollection|Productquestion[] Collection to store aggregation of Productquestion objects.
     */
    protected $collProductquestions;
    protected $collProductquestionsPartial;
     ...
     * @var		PropelObjectCollection
     */
    protected $productquestionsScheduledForDeletion = null;
    ...
    /**
     * Get the [product_depth] column value.
     *
     * @return string
     */
    ...
    public function setIdcategory($v)
    {
        ...
        if ($this->idcategory !== $v) {
            $this->idcategory = $v;
            $this->modifiedColumns[] = ProductPeer::IDCATEGORY;
        }
    ...
    /**
     * Set the value of [product_depth] column.
     *
     * @param  string $v new value
     * @return Product The current object (for fluent API support)
     */
    public function setProductDepth($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->product_depth !== $v) {
            $this->product_depth = $v;
            $this->modifiedColumns[] = ProductPeer::PRODUCT_DEPTH;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->product_depth = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->resetModified();
            ...
            return $startcol + 8; // 8 = ProductPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCategory !== null && $this->idcategory !== $this->aCategory->getIdcategory()) {
            $this->aCategory = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        if ($deep) {  // also de-associate any related objects?
            ...
            $this->collProductquestions = null;
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->productquestionsScheduledForDeletion !== null) {
                if (!$this->productquestionsScheduledForDeletion->isEmpty()) {
                    ProductquestionQuery::create()
                        ->filterByPrimaryKeys($this->productquestionsScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
                    $this->productquestionsScheduledForDeletion = null;
                }
            }

            if ($this->collProductquestions !== null) {
                foreach ($this->collProductquestions as $referrerFK) {
                    if (!$referrerFK->isDeleted() && ($referrerFK->isNew() || $referrerFK->isModified())) {
                        $affectedRows += $referrerFK->save($con);
                    }
                }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProductPeer::IDCATEGORY)) {
        ...
        if ($this->isColumnModified(ProductPeer::PRODUCT_DEPTH)) {
            $modifiedColumns[':p' . $index++]  = '`product_depth`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`product_high`':
                        ...
                        break;
                    case '`product_depth`':
                        $stmt->bindValue($identifier, $this->product_depth, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->collProductquestions) {
                $result['Productquestions'] = $this->collProductquestions->toArray(null, true, $keyType, $includeLazyLoadColumns, $alreadyDumpedObjects);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[7], $arr)) $this->setProductDepth($arr[$keys[7]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductPeer::PRODUCT_DEPTH)) $criteria->add(ProductPeer::PRODUCT_DEPTH, $this->product_depth);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setProductDepth($this->getProductDepth());
        ...
        if ($deepCopy && !$this->startCopy) {
            ...
            foreach ($this->getProductquestions() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addProductquestion($relObj->copy($deepCopy));
                }
            }
    ...
    {
        if ($this->aCategory === null && ($this->idcategory !== null) && $doQuery) {
            $this->aCategory = CategoryQuery::create()->findPk($this->idcategory, $con);
    ...
    public function initRelation($relationName)
    {
        ...
        if ('Productquestion' == $relationName) {
            $this->initProductquestions();
        }
    }
    ...
    public function clearMaterials()
    {
        ...
        $this->collMaterialsPartial = null;
     ...
     * @return void
     */
    public function resetPartialMaterials($v = true)
    {
        ...
        if (null === $this->collMaterials || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collMaterials) {
                ...
                if (null !== $criteria) {
                    ...
                    $collMaterials->getInternalIterator()->rewind();
    ...
    public function setMaterials(PropelCollection $materials, PropelPDO $con = null)
    {
        ...
        foreach ($materialsToDelete as $materialRemoved) {
            $materialRemoved->setProduct(null);
        }
    ...
    public function addMaterial(Material $l)
    {
        ...
        if (!in_array($l, $this->collMaterials->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
    ...
    public function clearProductphotos()
    {
        ...
        $this->collProductphotosPartial = null;
    ...
    public function initProductphotos($overrideExisting = true)
    {
        ...
        $this->collProductphotos = new PropelObjectCollection();
        $this->collProductphotos->setModel('Productphoto');
    }
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|Productphoto[] List of Productphoto objects
     * @throws PropelException
     */
        ...
        if (null === $this->collProductphotos || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collProductphotos) {
                ...
                if (null !== $criteria) {
                    ...
                    $collProductphotos->getInternalIterator()->rewind();
     ...
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $productphotos A Propel collection.
     * @param PropelPDO $con Optional connection object
     * @return Product The current object (for fluent API support)
     */
    public function setProductphotos(PropelCollection $productphotos, PropelPDO $con = null)
    {
    ...
    public function addProductphoto(Productphoto $l)
    {
        ...
        if (!in_array($l, $this->collProductphotos->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            ...
            if ($this->productphotosScheduledForDeletion and $this->productphotosScheduledForDeletion->contains($l)) {
                $this->productphotosScheduledForDeletion->remove($this->productphotosScheduledForDeletion->search($l));
            }
        }
    ...
    /**
     * Clears out the collProductquestions collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
     * @return Product The current object (for fluent API support)
     * @see        addProductquestions()
     */
    public function clearProductquestions()
    {
        $this->collProductquestions = null; // important to set this to null since that means it is uninitialized
        $this->collProductquestionsPartial = null;

        return $this;
    }

    /**
     * reset is the collProductquestions collection loaded partially
     *
     * @return void
     */
    public function resetPartialProductquestions($v = true)
    {
        $this->collProductquestionsPartial = $v;
    }

    /**
     * Initializes the collProductquestions collection.
     *
     * By default this just sets the collProductquestions collection to an empty array (like clearcollProductquestions());
     * however, you may wish to override this method in your stub class to provide setting appropriate
     * to your application -- for example, setting the initial array to the values stored in database.
     *
     * @param boolean $overrideExisting If set to true, the method call initializes
     ...
     * @return void
     */
    public function initProductquestions($overrideExisting = true)
    {
        if (null !== $this->collProductquestions && !$overrideExisting) {
            return;
        }
        $this->collProductquestions = new PropelObjectCollection();
        $this->collProductquestions->setModel('Productquestion');
    }

    /**
     * Gets an array of Productquestion objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     ...
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|Productquestion[] List of Productquestion objects
     * @throws PropelException
     */
    public function getProductquestions($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collProductquestionsPartial && !$this->isNew();
        if (null === $this->collProductquestions || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collProductquestions) {
                // return empty collection
                $this->initProductquestions();
            } else {
                $collProductquestions = ProductquestionQuery::create(null, $criteria)
                    ->filterByProduct($this)
                    ->find($con);
                if (null !== $criteria) {
                    if (false !== $this->collProductquestionsPartial && count($collProductquestions)) {
                      $this->initProductquestions(false);

                      foreach ($collProductquestions as $obj) {
                        if (false == $this->collProductquestions->contains($obj)) {
                          $this->collProductquestions->append($obj);
                        }
                      }

                      $this->collProductquestionsPartial = true;
                    }

                    $collProductquestions->getInternalIterator()->rewind();

                    return $collProductquestions;
                }

                if ($partial && $this->collProductquestions) {
                    foreach ($this->collProductquestions as $obj) {
                        if ($obj->isNew()) {
                            $collProductquestions[] = $obj;
                        }
                    }
                }

                $this->collProductquestions = $collProductquestions;
                $this->collProductquestionsPartial = false;
            }
        }

        return $this->collProductquestions;
    }

    /**
     * Sets a collection of Productquestion objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $productquestions A Propel collection.
     * @param PropelPDO $con Optional connection object
     * @return Product The current object (for fluent API support)
     */
    public function setProductquestions(PropelCollection $productquestions, PropelPDO $con = null)
    {
        $productquestionsToDelete = $this->getProductquestions(new Criteria(), $con)->diff($productquestions);


        $this->productquestionsScheduledForDeletion = $productquestionsToDelete;

        foreach ($productquestionsToDelete as $productquestionRemoved) {
            $productquestionRemoved->setProduct(null);
        }

        $this->collProductquestions = null;
        foreach ($productquestions as $productquestion) {
            $this->addProductquestion($productquestion);
        }

        $this->collProductquestions = $productquestions;
        $this->collProductquestionsPartial = false;
    ...
    /**
     * Returns the number of related Productquestion objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related Productquestion objects.
     * @throws PropelException
     */
    public function countProductquestions(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collProductquestionsPartial && !$this->isNew();
        if (null === $this->collProductquestions || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collProductquestions) {
            ...
            if ($partial && !$criteria) {
                return count($this->getProductquestions());
            }
            $query = ProductquestionQuery::create(null, $criteria);
            if ($distinct) {
                $query->distinct();
            }
        ...
        return count($this->collProductquestions);
    }

    /**
     * Method called to associate a Productquestion object to this object
     * through the Productquestion foreign key attribute.
     *
     * @param    Productquestion $l Productquestion
     * @return Product The current object (for fluent API support)
     */
    public function addProductquestion(Productquestion $l)
    {
        if ($this->collProductquestions === null) {
            $this->initProductquestions();
            $this->collProductquestionsPartial = true;
        ...
        if (!in_array($l, $this->collProductquestions->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            $this->doAddProductquestion($l);

            if ($this->productquestionsScheduledForDeletion and $this->productquestionsScheduledForDeletion->contains($l)) {
                $this->productquestionsScheduledForDeletion->remove($this->productquestionsScheduledForDeletion->search($l));
            }
        }
    ...
    /**
     * @param	Productquestion $productquestion The productquestion object to add.
     */
    protected function doAddProductquestion($productquestion)
    {
        $this->collProductquestions[]= $productquestion;
        $productquestion->setProduct($this);
    }

    /**
     * @param	Productquestion $productquestion The productquestion object to remove.
     * @return Product The current object (for fluent API support)
     */
    public function removeProductquestion($productquestion)
    {
        if ($this->getProductquestions()->contains($productquestion)) {
            $this->collProductquestions->remove($this->collProductquestions->search($productquestion));
            if (null === $this->productquestionsScheduledForDeletion) {
                $this->productquestionsScheduledForDeletion = clone $this->collProductquestions;
                $this->productquestionsScheduledForDeletion->clear();
            }
            $this->productquestionsScheduledForDeletion[]= clone $productquestion;
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->collProductquestions) {
                foreach ($this->collProductquestions as $o) {
                    $o->clearAllReferences($deep);
                }
            }
        ...
        $this->collMaterials = null;
        if ($this->collProductphotos instanceof PropelCollection) {
            $this->collProductphotos->clearIterator();
        }
        $this->collProductphotos = null;
        if ($this->collProductquestions instanceof PropelCollection) {
            $this->collProductquestions->clearIterator();
        }
        $this->collProductquestions = null;
        $this->aCategory = null;
    }
