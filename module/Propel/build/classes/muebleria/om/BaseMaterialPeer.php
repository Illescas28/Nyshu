...
abstract class BaseMaterialPeer
{
    ...
    const IDPRODUCT = 'material.idproduct';

    /** the column name for the material_name field */
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idmaterial', 'Idproduct', 'MaterialName', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idmaterial', 'idproduct', 'materialName', ),
        BasePeer::TYPE_COLNAME => array (MaterialPeer::IDMATERIAL, MaterialPeer::IDPRODUCT, MaterialPeer::MATERIAL_NAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDMATERIAL', 'IDPRODUCT', 'MATERIAL_NAME', ),
        BasePeer::TYPE_FIELDNAME => array ('idmaterial', 'idproduct', 'material_name', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idmaterial' => 0, 'Idproduct' => 1, 'MaterialName' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idmaterial' => 0, 'idproduct' => 1, 'materialName' => 2, ),
        BasePeer::TYPE_COLNAME => array (MaterialPeer::IDMATERIAL => 0, MaterialPeer::IDPRODUCT => 1, MaterialPeer::MATERIAL_NAME => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDMATERIAL' => 0, 'IDPRODUCT' => 1, 'MATERIAL_NAME' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('idmaterial' => 0, 'idproduct' => 1, 'material_name' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(MaterialPeer::IDMATERIAL);
            $criteria->addSelectColumn(MaterialPeer::IDPRODUCT);
            $criteria->addSelectColumn(MaterialPeer::MATERIAL_NAME);
        } else {
            $criteria->addSelectColumn($alias . '.idmaterial');
            $criteria->addSelectColumn($alias . '.idproduct');
            $criteria->addSelectColumn($alias . '.material_name');
        }
    }
    ...
    {
        // Invalidate objects in MaterialcolorPeer instance pool,
    ...
    public static function doCountJoinProduct(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(MaterialPeer::IDPRODUCT, ProductPeer::IDPRODUCT, $join_behavior);
    ...
    /**
     * Selects a collection of Material objects pre-filled with their Product objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinProduct(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Material) to $obj2 (Product)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Material) to the collection in $obj2 (Product)
                $obj2->addMaterial($obj1);
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(MaterialPeer::IDMATERIAL) && $criteria->keyContainsValue(MaterialPeer::IDMATERIAL) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(MaterialPeer::IDMATERIAL);
            $value = $criteria->remove(MaterialPeer::IDMATERIAL);
            if ($value) {
                $selectCriteria->add(MaterialPeer::IDMATERIAL, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(MaterialPeer::IDMATERIAL, (array) $values, Criteria::IN);
        }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            // delete related Materialcolor objects
            $criteria = new Criteria(MaterialcolorPeer::DATABASE_NAME);

            $criteria->add(MaterialcolorPeer::IDMATERIAL, $obj->getIdmaterial());
            $affectedRows += MaterialcolorPeer::doDelete($criteria, $con);
        }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(MaterialPeer::DATABASE_NAME);
        $criteria->add(MaterialPeer::IDMATERIAL, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(MaterialPeer::DATABASE_NAME);
            $criteria->add(MaterialPeer::IDMATERIAL, $pks, Criteria::IN);
