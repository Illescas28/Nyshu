...
abstract class BaseProductPeer
{
    ...
    const IDCATEGORY = 'product.idcategory';
    ...
    /** the column name for the product_depth field */
    const PRODUCT_DEPTH = 'product.product_depth';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idproduct', 'Idcategory', 'ProductName', 'ProductDescription', 'ProductPrice', 'ProductLong', 'ProductHigh', 'ProductDepth', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idproduct', 'idcategory', 'productName', 'productDescription', 'productPrice', 'productLong', 'productHigh', 'productDepth', ),
        BasePeer::TYPE_COLNAME => array (ProductPeer::IDPRODUCT, ProductPeer::IDCATEGORY, ProductPeer::PRODUCT_NAME, ProductPeer::PRODUCT_DESCRIPTION, ProductPeer::PRODUCT_PRICE, ProductPeer::PRODUCT_LONG, ProductPeer::PRODUCT_HIGH, ProductPeer::PRODUCT_DEPTH, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDPRODUCT', 'IDCATEGORY', 'PRODUCT_NAME', 'PRODUCT_DESCRIPTION', 'PRODUCT_PRICE', 'PRODUCT_LONG', 'PRODUCT_HIGH', 'PRODUCT_DEPTH', ),
        BasePeer::TYPE_FIELDNAME => array ('idproduct', 'idcategory', 'product_name', 'product_description', 'product_price', 'product_long', 'product_high', 'product_depth', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idproduct' => 0, 'Idcategory' => 1, 'ProductName' => 2, 'ProductDescription' => 3, 'ProductPrice' => 4, 'ProductLong' => 5, 'ProductHigh' => 6, 'ProductDepth' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idproduct' => 0, 'idcategory' => 1, 'productName' => 2, 'productDescription' => 3, 'productPrice' => 4, 'productLong' => 5, 'productHigh' => 6, 'productDepth' => 7, ),
        BasePeer::TYPE_COLNAME => array (ProductPeer::IDPRODUCT => 0, ProductPeer::IDCATEGORY => 1, ProductPeer::PRODUCT_NAME => 2, ProductPeer::PRODUCT_DESCRIPTION => 3, ProductPeer::PRODUCT_PRICE => 4, ProductPeer::PRODUCT_LONG => 5, ProductPeer::PRODUCT_HIGH => 6, ProductPeer::PRODUCT_DEPTH => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDPRODUCT' => 0, 'IDCATEGORY' => 1, 'PRODUCT_NAME' => 2, 'PRODUCT_DESCRIPTION' => 3, 'PRODUCT_PRICE' => 4, 'PRODUCT_LONG' => 5, 'PRODUCT_HIGH' => 6, 'PRODUCT_DEPTH' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('idproduct' => 0, 'idcategory' => 1, 'product_name' => 2, 'product_description' => 3, 'product_price' => 4, 'product_long' => 5, 'product_high' => 6, 'product_depth' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ProductPeer::IDPRODUCT);
            ...
            $criteria->addSelectColumn(ProductPeer::PRODUCT_DEPTH);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.product_depth');
        }
    }
    ...
    {
        // Invalidate objects in MaterialPeer instance pool,
        ...
        // Invalidate objects in ProductquestionPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
    ...
    public static function doCountJoinCategory(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ProductPeer::IDCATEGORY, CategoryPeer::IDCATEGORY, $join_behavior);
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(ProductPeer::IDPRODUCT) && $criteria->keyContainsValue(ProductPeer::IDPRODUCT) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(ProductPeer::IDPRODUCT);
            $value = $criteria->remove(ProductPeer::IDPRODUCT);
            if ($value) {
                $selectCriteria->add(ProductPeer::IDPRODUCT, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ProductPeer::IDPRODUCT, (array) $values, Criteria::IN);
        }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(MaterialPeer::IDPRODUCT, $obj->getIdproduct());
            $affectedRows += MaterialPeer::doDelete($criteria, $con);
            ...
            // delete related Productquestion objects
            $criteria = new Criteria(ProductquestionPeer::DATABASE_NAME);

            $criteria->add(ProductquestionPeer::IDPRODUCT, $obj->getIdproduct());
            $affectedRows += ProductquestionPeer::doDelete($criteria, $con);
        }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(ProductPeer::DATABASE_NAME);
        $criteria->add(ProductPeer::IDPRODUCT, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(ProductPeer::DATABASE_NAME);
            $criteria->add(ProductPeer::IDPRODUCT, $pks, Criteria::IN);
