...
abstract class BaseProductphoto extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the productphoto_img field.
     * @var        string
     */
    protected $productphoto_img;
    ...
    /**
     * Get the [productphoto_img] column value.
     *
     * @return string
     */
    public function getProductphotoImg()
    {

        return $this->productphoto_img;
    }
    ...
    /**
     * Set the value of [productphoto_img] column.
     *
     * @param  string $v new value
     * @return Productphoto The current object (for fluent API support)
     */
    public function setProductphotoImg($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->productphoto_img !== $v) {
            $this->productphoto_img = $v;
            $this->modifiedColumns[] = ProductphotoPeer::PRODUCTPHOTO_IMG;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->productphoto_img = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = ProductphotoPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProductphotoPeer::PRODUCTPHOTO_IMG)) {
            $modifiedColumns[':p' . $index++]  = '`productphoto_img`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`idproduct`':
                        ...
                        break;
                    case '`productphoto_img`':
                        $stmt->bindValue($identifier, $this->productphoto_img, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                return $this->getProductphotoImg();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getProductphotoImg(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setProductphotoImg($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductphotoPeer::PRODUCTPHOTO_IMG)) $criteria->add(ProductphotoPeer::PRODUCTPHOTO_IMG, $this->productphoto_img);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setProductphotoImg($this->getProductphotoImg());
