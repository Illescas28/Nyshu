...
abstract class BaseServicePeer
{
    ...
    /** the column name for the service_description field */
    const SERVICE_DESCRIPTION = 'service.service_description';

    /** the column name for the service_img field */
    const SERVICE_IMG = 'service.service_img';

    /** the column name for the service_background_img field */
    const SERVICE_BACKGROUND_IMG = 'service.service_background_img';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idservice', 'ServiceName', 'ServiceDescription', 'ServiceImg', 'ServiceBackgroundImg', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idservice', 'serviceName', 'serviceDescription', 'serviceImg', 'serviceBackgroundImg', ),
        BasePeer::TYPE_COLNAME => array (ServicePeer::IDSERVICE, ServicePeer::SERVICE_NAME, ServicePeer::SERVICE_DESCRIPTION, ServicePeer::SERVICE_IMG, ServicePeer::SERVICE_BACKGROUND_IMG, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDSERVICE', 'SERVICE_NAME', 'SERVICE_DESCRIPTION', 'SERVICE_IMG', 'SERVICE_BACKGROUND_IMG', ),
        BasePeer::TYPE_FIELDNAME => array ('idservice', 'service_name', 'service_description', 'service_img', 'service_background_img', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idservice' => 0, 'ServiceName' => 1, 'ServiceDescription' => 2, 'ServiceImg' => 3, 'ServiceBackgroundImg' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idservice' => 0, 'serviceName' => 1, 'serviceDescription' => 2, 'serviceImg' => 3, 'serviceBackgroundImg' => 4, ),
        BasePeer::TYPE_COLNAME => array (ServicePeer::IDSERVICE => 0, ServicePeer::SERVICE_NAME => 1, ServicePeer::SERVICE_DESCRIPTION => 2, ServicePeer::SERVICE_IMG => 3, ServicePeer::SERVICE_BACKGROUND_IMG => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDSERVICE' => 0, 'SERVICE_NAME' => 1, 'SERVICE_DESCRIPTION' => 2, 'SERVICE_IMG' => 3, 'SERVICE_BACKGROUND_IMG' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('idservice' => 0, 'service_name' => 1, 'service_description' => 2, 'service_img' => 3, 'service_background_img' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ServicePeer::IDSERVICE);
            $criteria->addSelectColumn(ServicePeer::SERVICE_NAME);
            $criteria->addSelectColumn(ServicePeer::SERVICE_DESCRIPTION);
            $criteria->addSelectColumn(ServicePeer::SERVICE_IMG);
            $criteria->addSelectColumn(ServicePeer::SERVICE_BACKGROUND_IMG);
        } else {
            $criteria->addSelectColumn($alias . '.idservice');
            $criteria->addSelectColumn($alias . '.service_name');
            $criteria->addSelectColumn($alias . '.service_description');
            $criteria->addSelectColumn($alias . '.service_img');
            $criteria->addSelectColumn($alias . '.service_background_img');
        }
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(ServicePeer::IDSERVICE) && $criteria->keyContainsValue(ServicePeer::IDSERVICE) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(ServicePeer::IDSERVICE);
            $value = $criteria->remove(ServicePeer::IDSERVICE);
            if ($value) {
                $selectCriteria->add(ServicePeer::IDSERVICE, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ServicePeer::IDSERVICE, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(ServicePeer::DATABASE_NAME);
        $criteria->add(ServicePeer::IDSERVICE, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(ServicePeer::DATABASE_NAME);
            $criteria->add(ServicePeer::IDSERVICE, $pks, Criteria::IN);
