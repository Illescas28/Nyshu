...
abstract class BaseContactPeer
{
    ...
    /** the column name for the idcontact field */
    const IDCONTACT = 'contact.idcontact';
    ...
    const CONTACT_EMAIL = 'contact.contact_email';

    /** the column name for the contact_phone field */
    const CONTACT_PHONE = 'contact.contact_phone';

    /** the column name for the contact_message field */
    const CONTACT_MESSAGE = 'contact.contact_message';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idcontact', 'ContactName', 'ContactEmail', 'ContactPhone', 'ContactMessage', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idcontact', 'contactName', 'contactEmail', 'contactPhone', 'contactMessage', ),
        BasePeer::TYPE_COLNAME => array (ContactPeer::IDCONTACT, ContactPeer::CONTACT_NAME, ContactPeer::CONTACT_EMAIL, ContactPeer::CONTACT_PHONE, ContactPeer::CONTACT_MESSAGE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDCONTACT', 'CONTACT_NAME', 'CONTACT_EMAIL', 'CONTACT_PHONE', 'CONTACT_MESSAGE', ),
        BasePeer::TYPE_FIELDNAME => array ('idcontact', 'contact_name', 'contact_email', 'contact_phone', 'contact_message', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idcontact' => 0, 'ContactName' => 1, 'ContactEmail' => 2, 'ContactPhone' => 3, 'ContactMessage' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idcontact' => 0, 'contactName' => 1, 'contactEmail' => 2, 'contactPhone' => 3, 'contactMessage' => 4, ),
        BasePeer::TYPE_COLNAME => array (ContactPeer::IDCONTACT => 0, ContactPeer::CONTACT_NAME => 1, ContactPeer::CONTACT_EMAIL => 2, ContactPeer::CONTACT_PHONE => 3, ContactPeer::CONTACT_MESSAGE => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDCONTACT' => 0, 'CONTACT_NAME' => 1, 'CONTACT_EMAIL' => 2, 'CONTACT_PHONE' => 3, 'CONTACT_MESSAGE' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('idcontact' => 0, 'contact_name' => 1, 'contact_email' => 2, 'contact_phone' => 3, 'contact_message' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ContactPeer::IDCONTACT);
            $criteria->addSelectColumn(ContactPeer::CONTACT_NAME);
            $criteria->addSelectColumn(ContactPeer::CONTACT_EMAIL);
            $criteria->addSelectColumn(ContactPeer::CONTACT_PHONE);
            $criteria->addSelectColumn(ContactPeer::CONTACT_MESSAGE);
        } else {
            $criteria->addSelectColumn($alias . '.idcontact');
            ...
            $criteria->addSelectColumn($alias . '.contact_message');
        }
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(ContactPeer::IDCONTACT) && $criteria->keyContainsValue(ContactPeer::IDCONTACT) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(ContactPeer::IDCONTACT);
            $value = $criteria->remove(ContactPeer::IDCONTACT);
            if ($value) {
                $selectCriteria->add(ContactPeer::IDCONTACT, $value, $comparison);
            } else {
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ContactPeer::IDCONTACT, (array) $values, Criteria::IN);
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(ContactPeer::DATABASE_NAME);
        $criteria->add(ContactPeer::IDCONTACT, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(ContactPeer::DATABASE_NAME);
            $criteria->add(ContactPeer::IDCONTACT, $pks, Criteria::IN);
